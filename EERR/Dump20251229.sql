...
--
-- Table structure for table `persona_colegio_rol`
--

DROP TABLE IF EXISTS `persona_colegio_rol`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `persona_colegio_rol` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_persona` int NOT NULL,
  `id_colegio` int NOT NULL,
  `id_rol` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_persona_colegio_rol` (`id_persona`,`id_colegio`,`id_rol`),
  KEY `fk_pcr_colegio` (`id_colegio`),
  KEY `fk_pcr_rol` (`id_rol`),
  CONSTRAINT `fk_pcr_colegio` FOREIGN KEY (`id_colegio`) REFERENCES `colegio` (`id_colegio`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_pcr_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_pcr_rol` FOREIGN KEY (`id_rol`) REFERENCES `rol_persona` (`id_rol`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-29 16:32:39
